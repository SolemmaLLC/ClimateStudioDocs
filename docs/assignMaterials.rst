...
material modifier to the right. The filter belows allows to search the material database by material type or certain properties such as total visual reflectance (Rvis(total)). 
